...
const dataTimeExam = [{time: '26/11/2022'}];
const data2 = [
  ...
  return (
    <ScrollView>
      ...
      <View style={styles.container}>
        <>
          <Text style={styles.title}>Đăng ký học lại</Text>
        </>
        ...
        {dataTimeExam.map((item, index) => (
          <Text style={{color: 'red', paddingLeft: 10, paddingTop: 5}}>
            Các đơn đăng ký từ {item.time} sẽ được trừ tự động nếu có số dư
            trong ví
          </Text>
        ))}
      </View>
      <View style={styles.container}>
        <View style={styles.content}>
          ...
          <>
            ...
            <Text style={styles.text}>Loại dịch vụ: Đăng ký học lại</Text>
            <View style={styles.column}>
              ...
              <SelectDropdown
                  ...
                  defaultButtonText="Chọn môn học"
