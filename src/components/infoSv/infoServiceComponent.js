...
function InfoServiceComponent({
    ...
    return (<>
                ...
                <>
                    ...
                    <Text style={styles.text}>Số tiền: 0</Text>
                    {
                        number && (<View >
                            ...
                            <Text style={styles.text}>Ngày đăng ký: {new Date().toLocaleDateString()}</Text>
        ...
        <View style={styles.container}>
            <TouchableOpacity   >
                <Text onPressIn={submit(typeSelect, info)} style={styles.touchable}>Hoàn tất đăng ký</Text>
            </TouchableOpacity>
        </View>
        <View style={styles.container}>
            <Text style={styles.text}>Lưu ý: Khi thực hiện thanh toán qua DNG mã sinh viên của bạn là <Text style={{ color: 'red', fontWeight: 'bold' }}>{info.user_code}</Text></Text>
